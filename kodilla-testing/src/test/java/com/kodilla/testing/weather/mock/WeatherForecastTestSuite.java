...
public class WeatherForecastTestSuite {
    ...
    void testCalculateAverageTemperatureWithMock() {
        ...
        //When
        double averageTemperature = weatherForecast.temperatureAverage();

        //Then
        double o = ((25.5 + 26.2 + 24.8 + 25.2 + 26.1) / 5);

        Assertions.assertEquals(o, averageTemperature, 0.02);
    }
    @Test
    void testCalculateMedianTemperatureWithMock() {
        ...
        Assertions.assertEquals(o, medianTemperature, 0.02);
    }
}
