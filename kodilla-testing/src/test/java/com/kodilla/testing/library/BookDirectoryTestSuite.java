...
import com.kodilla.testing.Book;
...
class BookDirectoryTestSuite {
    ...
    void testListBooksInHandsOf() {
        // Given
        BookLibrary bookLibrary = new BookLibrary(libraryDatabaseMock);
        LibraryUser libraryUser0 = new LibraryUser("Jan", "Kowalski", "Pesel1");
        LibraryUser libraryUser1 = new LibraryUser("Jan", "Kowalski", "Pesel2");
        LibraryUser libraryUser5 = new LibraryUser("Jan", "Kowalski", "Pesel3");
