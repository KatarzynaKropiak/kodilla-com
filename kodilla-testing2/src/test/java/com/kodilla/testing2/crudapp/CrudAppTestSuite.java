...
public class CrudAppTestSuite {
    private static final String BASE_URL = "https://katarzynakropiak.github.io";
    ...
    private boolean checkTaskExistsInTrello(String taskName) throws InterruptedException {
        ...
        driverTrello.findElement(By.id("user")).sendKeys("katarzyna.kropiak@gmail.com");
        driverTrello.findElement(By.id("password")).sendKeys("KodillaKurs123");
